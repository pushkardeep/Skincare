...
function NavButtons({ img, alt }) {
  return (
    <div className="group w-[35px] aspect-square bg-[#F8FEE5] flex justify-center items-center rounded-full cursor-pointer overflow-hidden">
      <div className="w-fit h-fit relative flex flex-col items-center justify-center transition-all duration-300 ease-in-out overflow-hidden">
        <img
        ...
        />
        <img
          className="w-[50%] aspect-square absolute top-[150%] transition-transform duration-300 ease-in-out group-hover:-translate-y-[150%] object-cover"
          src={img}
          alt={alt}
        />
      </div>
